...
@Autonomous(name = "RedGoalFar")
public class RedGoalFar extends LinearOpMode {
    AutoDrive autoDrive;
    Shoot shootUtil;
    ...
    public void runOpMode() {
        ...
        AimController aimController = new AimController(limelight, imu,0);
